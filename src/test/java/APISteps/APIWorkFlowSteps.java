...
public static String employee_id;
    ...
    public void the_response_body_contains_key_and_value(String key, String value) {
        //arguments from key and value is coming from  our feature file
    ...
    @Then("the employee id {string} is stored as global to be used for other requests")
    public void the_employee_id_is_stored_as_global_to_be_used_for_other_requests(String empId) {
...
//-----------------------------------------------
    ...
    @Then("the status code for creating an emp is {int}")
    public void the_status_code_for_creating_an_emp_is(Integer int1) {
       response.then().assertThat().statusCode(int1);

    }
    @Then("the employee id {string} should match with the global emp id")
    public void the_employee_id_should_match_with_the_global_emp_id(String string) {
    ...
    public void the_retrieved_data_at_object_should_match_with_the_data_used_for_creating_the_employee(String employeeObject, DataTable dataTable) {
        ...
        //datatable provides the data in the form of key and value

        List<Map<String,String>> expectedData=dataTable.asMaps(String.class,String.class);
        //to get all the key and values of employee object, we use jsonpath.get method
        //if one value we can use .getString
